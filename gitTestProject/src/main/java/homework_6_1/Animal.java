...
public class Animal {
    ...
    public Animal(String a, String b, String c, String d) {
        ...
        System.out.println(getColorAnimal(colorA));
        getVoiceAnimal(voiceA);
        checkSizeAnimal(sizeA);
        meatOrPlants = checkFoodAnimal(foodA);
        System.out.println(checkIsAnimalPredator(sizeA, meatOrPlants));
    }
    ...
    public void checkSizeAnimal(String size) {
